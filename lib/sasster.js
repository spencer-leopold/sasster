...
EstrnSass.prototype.start = function() {
  var end, self = this;
...
EstrnSass.prototype.glob = function(src, cwd) {
...
EstrnSass.prototype.compileSass = function(src) {
...
EstrnSass.prototype.watch = function() {
  var self = this;
...
EstrnSass.prototype.readFile = function(file) {
  return new Promise(function(resolve, reject) {
...
EstrnSass.prototype.buildImportMap = function(filesArr) {
  var self = this;
